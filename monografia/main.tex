...
O Ethereum foi o primeiro projeto bem-sucedido baseado em Blockchain desenvolvido especificamente para a execução de Smart Contracts, oferecendo uma linguagem de programação turing-completa com suporte a funções criptográficas e alguns metadados da blockchain.
Esta linguagem, chamada de \emph{Ethereum Virtual Machine code (EVM code)} (... continua)
