...
\subsection{Criptografia Baseada em Atributos} \label{sec:sub:cba}
...
Assim, foi modelada uma taxonomia de acordo com os papéis envolvidos na gestão e uso dos dados médicos de paciente, partindo da análise das normas que regem o trabalho do profissional da saúde. % TODO: (ok) o texto em vermelho permitirá ao leitor entender o que é taxonomia.
...
A taxonomia criada nesse trabalho é mostrada na Figura \ref{fig:taxonomiaPermissoes}. % TODO: usar PEPs (não usar prontuário médico pois é prontuário do paciente). Padronizar no texto todo
...
Esses atributos são: $Paciente$, $Terceiro\textnormal{-}Autorizado$ e $Representante\textnormal{-}Legal$. % TODO: (ok) representante legal?
...
\begin{figure}[h]
  ...
  \caption{Taxonomia de permissões de acesso ao Prontuário do Paciente} % TODO: (ok) Essa taxonomia é sua ou do CEM? Se for do CEM, precisa referenciar de onde a obteve
