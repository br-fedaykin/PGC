...
{\color{RoyalBlue} Professor, a explicação do que é ABI estará na sessão \ref{sub:sec:contratos-ethereum}, porque lá já estou abordando o Solidity e o bytecode (EVM Code)}
