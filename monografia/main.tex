...
Já há milhares de soluções\footnote{em 13 de novembro de 2019, há mais de 4.700 projetos registrados no CoinMarketCap e mais de 6.100 no coinlib, dois dos maiores sites agregadores de informações do mercado de criptomoedas.} baseadas em Blockchain, que se tornaram conhecidas como \emph{criptomoedas}, embora nem todas elas tenham o objetivo de serem utilizadas como um sistema de pagamentos, como é o caso da plataforma \emph{Ethereum}, utilizada nesse trabalho. Se faz necessário entender o conceito da Blockchain e como ela funciona para entender a rede \emph{Ethereum} plenamente.
