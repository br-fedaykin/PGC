...
O avanço das considerações da criptografia ABE e da Blockchain na área da saúde se encontraram em estudos recentes que são analisados a seguir e comparados quando possível ao trabalho proposto aqui.
As diferenças entre os trabalhos considerados mais relevantes estão resumidas na tabela \ref{tbl:comparacao-entre-trabalhos}.
...
\begin{table}[h]
  \begin{center}
    ...
    \begin{tabular}{lllll}
      \hline
      Propriedades & \cite{Sun2018} & \cite{Zhang2018} & \cite{Guo2020} & \makecell[l]{Smart\\DCPABE} \\
      \hline
      \makecell[l]{Baseado em\\Blockchain} & v & v & v & v \\
      Smart Contracts & x & x & v & v \\
      \makecell[l]{Controle\\de acesso} & x & v & v & v \\
      \makecell[l]{Lastreabilidade\\de Autoridades} & x & x & x & v \\
      \makecell[l]{Normalização\\semântica} & x & v & x & v \\
      \hline
    \end{tabular}
  \end{adjustbox}
  \caption{Comparação de propriedades sistêmicas dos trabalhos similares}
...
\begin{table}[h]
  \begin{center}
    ...
    \begin{tabular}{llllll}
      ...
      \hline
      Sun et al. \cite{Sun2018} & v & x & x & x & x \\
      Zhang e Lin \cite{Zhang2018} & v & x & v & x & v \\
      Guo et al. \cite{Guo2020} & v & v & v & x & x \\
      SmartDCPABE & v & v & v & v & v \\
      \hline
    \end{tabular}
  \end{adjustbox}
  \caption{Comparação de propriedades sistêmicas dos trabalhos similares}
  \label{tbl:comparacao-entre-trabalhos2}
\end{center}
\end{table}
...
Criptografia baseada em atributos é citada no trabalho, porém é a maneira como o sistema foi descrito torna inconclusivo a forma que ABE foi potencialmente utilizada neste trabalho.
