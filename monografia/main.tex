...
A ideia da Blockchain surge junto e por meio do Bitcoin em 2008 \cite{nakamoto2008bitcoin} e as possibilidades de seu uso como um Livro-Razão Distribuído continuam crescendo com novos algoritmos, protocolos e variadas áreas de aplicação.
Foi necessário a passagem do tempo para que se tornasse evidente a viabilidade da inovação trazida com o Bitcoin, atraindo a atenção do meio acadêmico que passou a estudar suas propriedades e suas aplicações.
Em 2016 os primeiros trabalhos na área médica com projetos usando Blockchain são publicados, focados em garantir a autenticidade de dados médicos com soluções baseadas em Blockchain \cite{Zhang2016,Azaria2016,Ekblaw2016}.
Particularmente, o sistema MedRec também implementa um mecanismo para integração de dados de pacientes fragmentados entre bases de dados distintas.
A união de esquemas ABE com compartilhamento de dados usando Blockchain demonstrou alguns resultados, que serão analisados e comparados com este trabalho a seguir.

\subsection{Sistemas na área de saúde usando Blockchain e ABE}
\label{sec:sub:saude-blockchain-cba}

Sun et al. \cite{Sun2018} apresentam um sistema para assegurar a autenticidade de dados médico por meio de Blockchain e promover o anonimato dos usuários envolvidos no sistema ao substituir o mecanismo nativo de geração de chaves do Bitcoin por um esquema usando ABE.
