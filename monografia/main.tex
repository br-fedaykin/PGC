...
\begin{table}[h]
  \begin{center}
    ...
    \begin{tabular}{lcccccc}
      ...
      \hline
      \makecell[l]{Baseado em\\Blockchain} & & v & v & v & v & v \\
      Smart Contracts & & x & x & v & x & v \\
      \makecell[l]{Controle\\de acesso} & & x & v & v & v & v \\
      \makecell[l]{Lastreabilidade\\de Autoridades} & & x & x & x & x & v \\
      \makecell[l]{Normalização\\semântica} & & x & v & x & x & v \\
      \hline
    \end{tabular}
  \end{adjustbox}
...
\begin{table}[h]
  \begin{center}
    ...
    \begin{tabular}{llllll}
      ...
      Yang et al. \cite{Yang2020} & v & x & v & x & x \\
